...
class CouponRepository{
  ...
  Future<CouponApplyResponse> getCouponApplyResponse(@required String coupon_code ) async {

    var post_body = jsonEncode({"user_id": "${user_id.value}","coupon_code": "$coupon_code"});
  ...
  Future<CouponRemoveResponse> getCouponRemoveResponse() async {
    ...
    var post_body = jsonEncode({"user_id": "${user_id.value}"});
