  ...
  onPressSubmit() async {
    ...
    if (amount == "" || name == "" || trx_id == "") {
      ToastComponent.showDialog(
          "Amount,Name and Transaction Id are necessary", context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }

    if (_photo_path == "" || _photo_upload_id == 0) {
      ToastComponent.showDialog("Photo proof is necessary", context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }
    ...
    if (status.isDenied) {
      ...
      showDialog(
          ...
          builder: (BuildContext context) => CupertinoAlertDialog(
                ...
                content: Text('This app needs permission'),
                actions: <Widget>[
      ...
      _photo_file = await ImagePicker.pickImage(source: ImageSource.gallery);
      ...
      //return;
      String base64Image = base64Encode(_photo_file.readAsBytesSync());
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(bottom: 4.0),
              child: Text(
                "Photo Proof* (only image file allowed)",
                style: TextStyle(
                    color: MyTheme.accent_color, fontWeight: FontWeight.w600),
              ),
            ),
