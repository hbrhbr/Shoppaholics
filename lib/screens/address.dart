...
class _AddressState extends State<Address> {
  ...
  fetchAll() {
    fetchCityList().then((city_list_val) {
      fetchCountryList().then((val) {
        if (is_logged_in.value == true) {
  ...
  fetchShippingAddressList() async {
    ...
    if (_shippingAddressList.length > 0) {
      ...
      _shippingAddressList.forEach((address) {
        print(count++);
        print("<address.city>");
        print(_shippingAddressList.length);
        print(_cityList.toString());
        print(_countryList.toString());
        print(address.city);
        print(address.city.length);
        var acity = getCityByPartialName(address.city);
        var acountry = getCountryByPartialName(address.country);
        print(acity.toString() + " " + acountry.toString());
        print("</address.city>");
    ...
    // print('--The list starts--');
    // print(_selected_city_name_list_for_update.length);
    // print(_selected_city_name_list_for_update.toString());
    // print('--------------------------------------------');
    // print(_selected_city_list_for_update.length);
    // print(_selected_city_list_for_update.toString());
    // print('--------------------------------------------');
    // print(_selected_country_name_list_for_update.length);
    // print(_selected_country_name_list_for_update.toString());
    // print('--------------------------------------------');
    // print(_selected_country_list_for_update.length);
    // print(_selected_country_list_for_update.toString());
    // print('--------------------------------------------');
    // print('--The list ends--');
    setState(() {});
  }
