...
class _SslCommerzScreenState extends State<SslCommerzScreen> {
  ...
  buildBody() {
/*    String initial_url =
        "${AppConfig.BASE_URL}/sslcommerz/begin?payment_type=${widget.payment_type}&combined_order_id=${_combined_order_id}&amount=${widget.amount}&user_id=${user_id.value}";*/
    ...
    if (_order_init == false &&
      ...
      return Container(
        child: Center(
          child: Text("Fetching sslcommerz url ..."),
        ),
      );
    } else {
